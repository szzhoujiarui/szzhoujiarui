...
- **[DeepTutor #756](https://github.com/HKUDS/DeepTutor/pull/756) · Give research read-only access to Obsidian** — Enables the research pipeline to search, read, and browse trusted vault content without mounting an unavailable RAG index.
